...
public class NettyHttpMessageHandler extends SimpleChannelInboundHandler<FullHttpRequest>{
	...
	protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest msg) throws Exception {
		...
		//logger.info("Receive Response Message Header waiting for "+template.getReceiveTimeout()+"ms.....");
		...
		FullHttpResponse response = (FullHttpResponse)converter.fromMessage(responseMessage, FullHttpResponse.class);
