...
public class SnmpInboundChannelAdapterParserTests {
	...
	private AbstractMessageChannel snmpResponse;
	...
	public void testInboundChannelAdapterParser() throws Exception {
		...
		Assert.assertNotNull(snmpResponse);
		Assert.assertEquals("snmpResponse", snmpResponse.getComponentName());
